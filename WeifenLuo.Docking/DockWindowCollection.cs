...
namespace WeifenLuo.Docking
{
    public class DockWindowCollection : ReadOnlyCollection<DockWindow>
    {
        ...
        {
            Items.Add(dockPanel.CreateDockWindow(dockPanel, DockState.Document));
            Items.Add(dockPanel.CreateDockWindow(dockPanel, DockState.DockLeft));
            Items.Add(dockPanel.CreateDockWindow(dockPanel, DockState.DockRight));
            Items.Add(dockPanel.CreateDockWindow(dockPanel, DockState.DockTop));
            Items.Add(dockPanel.CreateDockWindow(dockPanel, DockState.DockBottom));
        }
