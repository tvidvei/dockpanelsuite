    ...
    internal class DockPaneCaption : DockPaneCaptionBase
    {
        ...
        private InertButtonBase ButtonClose
        {
            get
            {
                ...
                {
                    m_buttonClose = new DockPaneCaptionInertButton(this,
        ...
        private InertButtonBase ButtonAutoHide
        {
            get
            {
                ...
                {
                    m_buttonAutoHide = new DockPaneCaptionInertButton(this,
        ...
        private InertButtonBase ButtonOptions
        {
            get
            {
                ...
                {
                    m_buttonOptions = new DockPaneCaptionInertButton(this,
        ...
        public DockPaneCaption(DockPane pane) : base(pane)
        {
            SuspendLayout();
        ...
        private void DrawCaption(Graphics g)
        {
            ...
            var border = DockPane.DockPanel.Theme.Colors.MainBorder;
            ...
            if (DockPane.IsActivePane)
            {
                ...
                gripColor = DockPane.DockPanel.Theme.Colors.TabActiveGrip;
            }
            else
            {
                ...
                gripColor = DockPane.DockPanel.Theme.Colors.TabNormalGrip;
            }

            SolidBrush captionBrush = DockPane.DockPanel.Theme.PaintingService.GetBrush(backgroundColor);
            ...
            DrawDotsStrip(g, rectDotsStrip, gripColor);
        }
